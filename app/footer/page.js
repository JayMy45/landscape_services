    ...
    return (
        <>
            ...
            <footer className=" bg-stone-400 dark:bg-stone-700 bg-opacity-95 dark:bg-opacity-95 pt-2 shadow-md">
                ...
                <div className="footer flex h-44 px-5 mx-auto">
                    ...
                    <div className="hidden md:block text-center ml-10 md:w-6/12 lg:w-7/12">
                        <div className="py-4 ">
                            <ul className="inline-flex md:justify-between lg:justify-evenly items-center py-16 md:w-80 lg:w-full">
                                <Link href="/">
                                    <li className="hover:border-b border-blue-50 p-1 text-blue-50">Home</li>
                                </Link>
                                <Link href="#about">
                                    <li className="hidden md:block hover:border-b border-blue-50 p-1 text-blue-50">About</li>
                                    <li className="block md:hidden hover:border-b border-blue-50 p-1 text-blue-50">About Us</li>
                                </Link>
                                <Link href="#area">
                                ...
                                <Link href="#contact">
                                    <li className="hidden md:block hover:border-b border-blue-50 p-1 text-blue-50">Contact</li>
                                    <li className="block md:hidden hover:border-b border-blue-50 p-1 text-blue-50">Contact Us</li>
                                </Link>
                            </ul>
                        </div>
                    </div>

                    <div className="hidden lg:block lg:w-3/12 text-left">
                    ...
                    <div className="lg:hidden block w-5/12 md:w-3/12 lg:w-3/12 text-left">
